...
info "2. Run the anonymizer: cargo run --bin c2pa-x509-zk-anonymizer -- --input fixtures/signed-cards.png --output /tmp/anon.png --ca crates/c2pa-x509-zk-demo/resources/root-ca.pem"
